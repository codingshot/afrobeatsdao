...
function AlbumCountdown() {
  ...
  if (timeLeft <= 0) return <span className="text-2xl font-bold text-afro-orange">Album is out now!</span>;
  ...
  return (
    <div className="flex gap-4 text-3xl font-bold text-afro-black justify-center mt-4 bg-afro-yellow/60 p-2 rounded-full">
...
export function MusicSection() {
  ...
  return (
    <section id="music" className="py-20 bg-afro-orange text-afro-black font-afro">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
          <div className="md:w-1/2">
            <div className="relative aspect-square max-w-md mx-auto">
              <div className="absolute inset-2 border-4 border-dashed border-afro-teal rounded-2xl"></div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-6xl text-afro-yellow">▶️</span>
              </div>
            </div>
          </div>
          <div className="md:w-1/2 mt-8 md:mt-0 w-full">
            <h3 className="text-2xl font-heading font-bold mb-4 text-center md:text-left">
              Stream our free CC0 album and vibe to Afrobeats culture! 🎶
            </h3>
            {/* Dropdown mimic with countdown & streaming buttons below when open */}
            <div className="bg-afro-yellow rounded-xl p-6 w-full max-w-xs mx-auto shadow-2xl text-center">
              <button className="flex items-center justify-center gap-2 w-full text-xl font-heading font-bold text-afro-teal mb-4 focus:outline-none" onClick={() => setIsOpen(!isOpen)}>
              ...
              {isOpen && (
                <div>
                  ...
                  <div className="flex flex-row gap-4 justify-center mt-6">
                    <Button className="bg-gray-200 text-gray-500 flex items-center gap-2 py-4 text-lg shadow-lg cursor-not-allowed w-full max-w-[110px]" disabled>
                  ...
                  <p className="text-center text-afro-teal mt-6">
