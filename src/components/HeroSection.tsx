      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 flex flex-col md:flex-row items-center justify-center gap-4">
            <span className="text-7xl md:text-8xl animate-emoji-bounce" aria-label="Drum emoji">🪘</span>
          ...
          <div className="flex flex-row gap-6 items-center justify-center w-full max-w-md mx-auto">
            <Button 
            ...
            <Button
              className="bg-[#E63946] hover:bg-[#E63946]/80 text-white text-lg px-8 py-6 rounded-full shadow-lg transition hover:scale-105 flex items-center gap-2 justify-center w-full"
              onClick={() => document.getElementById('music')?.scrollIntoView({ behavior: 'smooth' })}
              variant="secondary"
            >
              <span>Listen to Album</span>
            </Button>
          </div>
        </div>
      </div>
