        ...
        <div className="flex flex-col items-center justify-center gap-8 py-16">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="relative">
              <CalendarOff className="h-16 w-16 text-afro-orange opacity-80 mb-2" />
              <PartyPopper className="h-9 w-9 text-afro-teal opacity-90 absolute -right-4 -top-4 rotate-12" />
            </div>
            <p className="text-xl font-heading text-afro-black mt-2">No events right now. Stay tuned for future Afrobeats parties!</p>
          </div>
          <Button
            className="bg-afro-teal hover:bg-afro-orange text-afro-yellow text-lg font-heading px-8 py-6 rounded-full shadow-lg transform transition hover:scale-105 flex items-center gap-2 justify-center"
