  ...
  return <section id="events" className="py-16 font-afro bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center gap-8 py-16">
          ...
          <Button className="bg-[#E63946] hover:bg-red-700 text-white text-lg font-heading px-8 py-6 rounded-full shadow-lg transform transition hover:scale-105 flex items-center gap-2 justify-center mx-auto" onClick={() => window.open("https://discord.gg/TNrWwSA955", "_blank")}>
            Tap In
          </Button>
        </div>
      </div>
