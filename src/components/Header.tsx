    ...
    <header className={`fixed top-0 w-full z-50 bg-[#FFD600] shadow-md font-heading transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link to="/" className="font-semibold text-black hover:text-black/70 transition-colors">
            Home
          </Link>
          <Link to="/dance" className="font-semibold text-black hover:text-black/70 transition-colors">
            Dance
          </Link>
        </div>
