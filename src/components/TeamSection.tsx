      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {teamMembers.map(member => (
            <div key={member.name} className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center border-4 border-afro-orange max-w-xs">
