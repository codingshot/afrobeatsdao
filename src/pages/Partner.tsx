...
import { Calendar, Video, Shirt, Music, Users, Heart, Instagram, Twitter, Newspaper, Star, Play, MapPin, Megaphone, Globe, Handshake, TrendingUp, Target, Zap, MessageCircle } from 'lucide-react';
      ...
      <section className="relative py-20 bg-gradient-to-br from-afro-yellow to-afro-orange">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-heading font-bold text-black mb-6">Partner with US</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {benefits.map((benefit, index) => <Card key={index} className="text-center border-2 border-afro-orange hover:shadow-lg transition-shadow">
                <CardHeader>
      ...
      <section id="partnership-types" className="py-16 bg-afro-yellow">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {partnershipTypes.map(type => <Card key={type.id} className="border-2 border-afro-teal hover:shadow-lg transition-all hover:scale-105">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button className="w-full bg-afro-orange text-white hover:bg-afro-orange/90" onClick={handleDiscordJoin}>
                      {type.cta}
                    </Button>
                  </div>
                </CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white/10 border-white/20 text-white">
              ...
              <CardContent>
                ...
                <Button className="bg-afro-yellow text-black hover:bg-afro-yellow/90" onClick={handleDiscordJoin}>
                  Join Our DAO
                </Button>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-afro-orange text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-8">
            {teamMembers.map(member => <Card key={member.name} className="bg-white text-black max-w-xs">
                ...
                <CardContent>
                  <div className="flex justify-center gap-3">
                    {member.twitter && <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="text-[#1DA1F2] hover:text-afro-orange transition-colors">
                        <Twitter className="h-5 w-5" />
                      </a>}
                    {member.instagram && <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="text-[#E4405F] hover:text-afro-orange transition-colors">
                        <Instagram className="h-5 w-5" />
                      </a>}
                    {member.linkedin && <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:text-afro-orange transition-colors">
          ...
          <div className="text-center">
            <Button size="lg" className="bg-white text-afro-orange hover:bg-gray-100 font-heading text-xl px-8 py-6 h-auto" onClick={handleDiscordJoin}>
