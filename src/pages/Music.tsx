...
const Music = () => {
  ...
  // Filter playlists based on search and platform filter
        ...
        <main className="container mx-auto px-4 py-4">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-xl max-w-2xl mx-auto text-black/90">
              Discover artists, playlists and the vibe of the day
            </p>
          </div>
                    ...
                    {filteredPlaylists.length > 0 ? (
                      filteredPlaylists.map(playlist => (
                        <motion.div
                          ...
                          transition={{ duration: 0.3 }}
                          className="flex items-center gap-4 p-4 bg-white rounded-lg border hover:bg-accent/5 transition-colors w-full mb-4"
                        >
