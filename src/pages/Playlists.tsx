...
const PLAYLISTS: Playlist[] = [
  {
    ...
    platform: "spotify",
    image:
      "https://mosaic.scdn.co/640/ab67616d0000b2733b812c8a29a8015e6ea11e35ab67616d0000b2735c5d15730deab2e48e2ae493ab67616d0000b273bb7610dfa8b8b17b2af9e81a",
  ...
  },
  {
    ...
    platform: "apple",
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/AMPCollection112/v4/76/49/61/764961b7-b7d8-f23e-7ff3-0ed85b5aaafb/25766af5-0af9-4116-9b7e-2312c9192dcd.png/1200x1200bb.jpg",
  ...
  },
  {
    id: "homealone-dj-mix",
    title:
      "HOME ALONE LIVE SET | DJ DID | AMAPIANO | DANCEHALL | AFROHOUSE | AFROBEATS | BASHMENT EDITION",
    platform: "youtube",
  ...
  },
  {
    ...
    title:
      "003 DJ Six Seven IN 808's Kitchen ( 2025 Afrobeats, House & Amapiano Mix )",
    platform: "youtube",
    image: "https://i.ytimg.com/vi/OXlq7aHVtgA/maxresdefault.jpg",
    url: "https://www.youtube.com/watch?v=OXlq7aHVtgA",
    description:
      "Location: 808's Kitchen, Lagos featuring DJ Six Seven, May 2025.",
  },
  {
    id: "priyanka-soulful-amapiano",
    title:
      "Soulful Amapiano Mix | Cape Town, South Africa | Kelvin Momo, Kabza De Small, DJ Maphorisa",
    platform: "youtube",
  ...
  },
  {
    ...
    description:
      "2/3 CULTUR FM Paris. This release we have N.A.S on the decks. Afrobeats x Francophone... Expect a lot of old school tracks you probably have not heard in a while. Jan 2025.",
  },
  {
    id: "culturfm-nsg",
  ...
  },
  {
    ...
    platform: "apple",
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/AMPCollection123/v4/e6/49/59/e649591a-d322-4d3c-9f97-9096e57e8b8f/bd7f4ba7-7873-4f72-a6a5-e3aa9b2c9b0e.png/1200x1200bb.jpg",
  ...
  },
  {
    ...
    platform: "apple",
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/c9/36/20/c9362006-9a28-4a74-b401-a2368b0afa58/196922028953_Cover.jpg/1200x1200bb.jpg",
...
const Playlists = () => {
  ...
  const { playNow, addToQueue, queue, currentSong, reorderQueue } =
    audioPlayerContext;
  ...
  const handleAddToQueue = (playlist: Playlist) => {
    if (playlist.platform === "youtube") {
      const videoId =
        playlist.url.split("v=")[1] || playlist.url.split("youtu.be/")[1];
      addToQueue({
        id: playlist.id,
        youtube: videoId,
  ...
  const filteredPlaylists = useMemo(() => {
    let filtered = PLAYLISTS.filter((playlist) => {
      ...
      const matchesPlatform =
        platformFilter === "all" || playlist.platform === platformFilter;
  ...
  const exportQueueAsMarkdown = () => {
    ...
    if (filteredQueue.length === 0) {
      ...
      filteredQueue.forEach((song, index) => {
        ...
        markdownContent += `   - Video ID: ${getVideoIdFromUrl(
          song.youtube
        )}\n`;
        markdownContent += `   - URL: https://www.youtube.com/watch?v=${getVideoIdFromUrl(
          song.youtube
        )}\n\n`;
      });
    }
  ...
  const filteredQueue = queue.filter(
    (song) => !showPlayedSongs || !playedSongs.has(song.id)
  );

  const metaDescription = `Discover the best ${
    platformFilter === "all" ? "Afrobeats" : platformFilter
  } music playlists. ${
    filteredPlaylists.length
  } curated playlists featuring top African artists and trending songs.`;

  return (
    <>
      <Helmet>
        <title>
          African Music Playlists - Afrobeats & Amapiano Collections
        </title>
        <meta name="description" content={metaDescription} />
        <meta
          property="og:title"
          content="African Music Playlists - Discover Afrobeats & Amapiano"
        />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:type" content="website" />
        <meta
          name="keywords"
          content="afrobeats playlists, amapiano playlists, african music, spotify playlists, youtube playlists"
        />
      ...
      <div className="min-h-screen bg-background pt-4 pb-[150px] md:pb-[93px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div
              className={`col-span-1 md:col-span-2 lg:col-span-3 ${
                queueVisible ? "lg:col-span-2" : "lg:col-span-4"
              }`}
            >
              <Tabs
                value={currentTab}
                    ...
                    {filteredPlaylists.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <p className="text-lg text-black/70">
                          No playlists found. Try adjusting your filters.
                        </p>
                      </div>
                    )}
                  </AnimatePresence>
                                        ...
                                        >
                                          ...
                                          <div className="relative flex-shrink-0 w-16 h-12 rounded-md overflow-hidden">
                                            <img
                                              ...
                                              alt={
                                                song.title || "Video thumbnail"
                                              }
                                              className="w-full h-full object-cover"
                                              onError={(e) => {
                                                e.currentTarget.src =
                                                  "/AfrobeatsDAOMeta.png";
                                              }}
                                            />
                                            <Button
                                              variant="ghost"
