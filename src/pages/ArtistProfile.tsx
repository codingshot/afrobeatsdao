...
const ArtistProfile = () => {
  ...
  if (!artist) {
    return (
      <>
        <Helmet>
          <title>
            Artist Not Found | Afrobeats.party - African Music & Culture
          </title>
          <meta
            name="description"
            content="The requested artist could not be found. Discover amazing African artists and Afrobeats music on Afrobeats.party - your gateway to African culture."
          />
          <meta
            property="og:title"
            content="Artist Not Found | Afrobeats.party"
          />
          <meta
            property="og:description"
            content="Discover amazing African artists and Afrobeats music on Afrobeats.party"
          />
          <meta
            property="og:image"
  ...
  const metaDescription =
    ...
    (safeGenre
      ? "Experience the best of " + safeGenre + " "
      : "Stream Afrobeats ") +
  ...
  const ogImage = safeImage
    ? "https://afrobeats.party" + safeImage
            ...
            <div className="md:col-span-1">
              ...
              <div className="bg-white p-4 rounded-xl shadow-md">
                ...
                <p className="text-gray-600 mt-3 text-sm">
                  {artist.name} is known for combining African rhythms with
                  contemporary sounds, creating a unique blend that has gained
                  ...
                  {ARTISTS.filter((a) => a.id !== artist.id)
                    ...
                    .map((relatedArtist) => (
                      <div
                        ...
                        onClick={() =>
                          navigate(`/music/artist/${relatedArtist.id}`)
                        }
                      >
